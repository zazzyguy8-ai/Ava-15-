...
const styles: Record<string, React.CSSProperties> = {
  ...
  loadTitle: { fontFamily: "'Playfair Display',serif", fontSize: "1.2rem", color: "#fff", margin: 0 },
  loadSub: { fontSize: ".82rem", color: "rgba(255,255,255,.35)", margin: 0 },
  ...
  h1: { fontFamily: "'Playfair Display',serif", fontSize: "clamp(1.6rem,4vw,2.2rem)", fontWeight: 700, color: "#fff", marginBottom: "1.2rem", lineHeight: 1.2 },
  h2: { fontFamily: "'Playfair Display',serif", fontSize: "clamp(1.2rem,3vw,1.55rem)", fontWeight: 600, color: "#e8a0b0", marginTop: "2.5rem", marginBottom: ".8rem", paddingBottom: ".5rem", borderBottom: "1px solid rgba(201,98,122,.2)", lineHeight: 1.3 },
  h3: { fontSize: "1rem", fontWeight: 600, color: "#d4a96a", marginTop: "1.5rem", marginBottom: ".4rem", letterSpacing: ".02em" },
  p: { fontSize: ".93rem", lineHeight: 1.8, color: "rgba(255,255,255,.65)", marginBottom: ".85rem" },
  ul: { listStyle: "none", padding: 0, margin: "0 0 1rem" },
  li: { display: "flex", alignItems: "flex-start", gap: 10, fontSize: ".9rem", lineHeight: 1.7, color: "rgba(255,255,255,.6)", marginBottom: ".4rem" },
  liDot: { color: "#c9627a", fontSize: ".7rem", marginTop: ".35rem", flexShrink: 0 },
  strong: { color: "#e8a0b0", fontWeight: 600 },
  hr: { border: "none", borderTop: "1px solid rgba(201,98,122,.15)", margin: "2rem 0" },
  writingRow: { display: "flex", alignItems: "center", gap: 10, marginTop: 24, paddingTop: 16, borderTop: "1px solid rgba(255,255,255,.06)" },
  ...
  doneBox: { display: "flex", alignItems: "center", gap: 10, marginTop: 32, padding: "16px 20px", borderRadius: 14, background: "rgba(212,169,106,.08)", border: "1px solid rgba(212,169,106,.2)", fontSize: ".82rem", color: "#d4a96a" },
